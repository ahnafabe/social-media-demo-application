package com.example.social_media_demo_app;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        email = findViewById(R.id.login_email); //email textfield
        password = findViewById(R.id.login_password); // password textfield
        newdnewaccount = findViewById(R.id.needs_new_account); // new account redirection
        reocverpass = findViewById(R.id.forgetp); // recover password redirection
